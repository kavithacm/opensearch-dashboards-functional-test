...
if(Cypress.env("SECURITY_ENABLED")) {
    describe('Home(Get Started) page', () => {
        ...
        it('should redirect to Auth page', () => {
            ...
            cy.get('button[data-test-subj="review-authentication-and-authorization"]').click({ force: true });
        ...
        it('should redirect to view Roles page', () => {
            ...
            cy.get('button[data-test-subj="explore-existing-roles"]').click({ force: true });
        ...
        it('should redirect to view Users page', () => {
            ...
            cy.get('button[data-test-subj="map-users-to-role"]').click({ force: true });
        ...
        it('should redirect to create Users page', () => {
            ...
            cy.get('button[data-test-subj="create-internal-user"]').click({ force: true });
        ...
        it('should redirect to Audit Logging page', () => {
            ...
            cy.get('button[data-test-subj="review-audit-log-configuration"]').click({ force: true });
